...
def pearson_score(dataset, user1, user2):
    ...
    user1_squared_sum = np.sum([np.square(dataset[user1][item]) for item in com-mon_movies])
    user2_squared_sum = np.sum([np.square(dataset[user2][item]) for item in com-mon_movies])
